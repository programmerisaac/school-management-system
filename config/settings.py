...
MIDDLEWARE = [
    ...
    'apps.core.middleware.SchoolSwitchMiddleware',
    'apps.core.middleware.ActiveSchoolMiddleware',
]
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@schoolms.com')
